...
const resources = {
	en: {
		translation: {
			...
			"project.Formalizz.API-la-Post-para2-1": "Users of the Formalizz website automatically generate letters, associated with a registered mail number with acknowledgment of receipt (RAR)",
			...
			"project.Formalizz.API-la-Post-li3-1": "The controller prepares and sends an SQL query to the database.",
			"project.Formalizz.API-la-Post-li3-2": "Requesting the RAR numbers of all the letters generated for this client.",
	...
	fr: {
		translation: {
			...
			"project.Formalizz.API-la-Post-para2-2": "La fonctionnalité décrite ici permet de connaître en un coup d'œil de statut d'un courrier.",
			...
			"project.Formalizz.API-la-Post-li3-1": "Le contrôleur prépare et envoie une requête SQL à la base de données.",
			"project.Formalizz.API-la-Post-li3-2": "Requiérant les numéros RAR  de tous les couriers générés pour ce client.",
			...
			"project.Formalizz.API-la-Post-li5-3": "Sur chaque ligne est ajoutée un pictogramme d'enveloppe blanche sur fond blue.",
			"project.Formalizz.API-la-Post-li5-4": "Le contrôleur convertit la liste de clients en une variable JSON. L'identifiant du client est lié RAR le plus récent.",
			"project.Formalizz.API-la-Post-li6-1": "La vue, en javaScript, va faire une requête asynchrone sur l'API interne.",
			"project.Formalizz.API-la-Post-li6-2": "Cette API interne est indispensable car l'API de La Poste étant sur un domaine différent, les restrictions de navigateur de type \"Cross Origin\" interdisent la requête directement sur les domaines externes.",
			...
			"project.Formalizz.API-la-Post-li11-2": "La couleur des pictogrammes enveloppe sont mises à jours au regard du statut du courier.",
		}
	}
};
